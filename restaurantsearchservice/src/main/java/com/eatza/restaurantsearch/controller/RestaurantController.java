...
public class RestaurantController {
	...
	public ResponseEntity<String> addRestaurant(@RequestHeader(required=false) String authorization,@RequestBody RestaurantRequestDto restaurantDto){
	...
	public ResponseEntity<RestaurantResponseDto> getRestaurantsByName(@RequestHeader(required=false) String authorization,@PathVariable String name,@RequestParam(defaultValue="1") int pagenumber,@RequestParam(defaultValue="10") int pagesize) {
	...
	public ResponseEntity<RestaurantResponseDto> getRestaurantsByLocationCuisine(@RequestHeader(required=false) String authorization,@PathVariable String location, @PathVariable String cuisine, @RequestParam(defaultValue="1") int pagenumber,@RequestParam(defaultValue="10") int pagesize) {
	...
	public ResponseEntity<RestaurantResponseDto> getRestaurantsByLocationName(@RequestHeader(required=false) String authorization,@PathVariable String location, @PathVariable String name, @RequestParam(defaultValue="1") int pagenumber,@RequestParam(defaultValue="10") int pagesize) {
		logger.debug("In get restaurants by location and cuisine method");
	...
	public ResponseEntity<RestaurantResponseDto> getRestaurantsByBudget(@RequestHeader(required=false) String authorization,@PathVariable int budget ,@RequestParam(defaultValue="1") int pagenumber,@RequestParam(defaultValue="10") int pagesize) {
	...
	public ResponseEntity<RestaurantResponseDto> getRestaurantsByRating(@RequestHeader(required=false) String authorization,@PathVariable double rating, @RequestParam(defaultValue="1") int pagenumber,@RequestParam(defaultValue="10") int pagesize) {
	...
	public ResponseEntity<List<MenuItem>> getItemsByRestaurantId(@RequestHeader(required=false) String authorization,@PathVariable Long restaurantid, @RequestParam(defaultValue="1") int pagenumber,@RequestParam(defaultValue="10") int pagesize) {
